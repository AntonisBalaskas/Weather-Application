...
public class MainView<cityName> extends UI {
    ...
    private void setLogo() {
        ...
        logo.setSource(new ExternalResource("http://openweathermap.org/img/wn/02d@2x.png"));
        logo.setWidth("500px");
    ...
    private void dashboardDetails(){
        ...
        // Pressure, Humidity, Wind, Feels Like 
    ...
    private void footer(){
        ...
        description.setValue("OpenWeatherMap Application with Spring Boot and Vaadin");
        footer.addComponents(description);
        mainLayout.addComponents(footer);
    }


    //UI Update Method Search Button must be clicked
    
    private void updateUI() throws JSONException {
    	
        //Getting City name from text field and assigning it to API URL
        ...
        windSpeedLabel.setValue("Wind: "+weatherService.returnWindObject().getInt("speed")+"m/s"+ ", degree: " + weatherService.returnWindObject().getDouble("deg")); 
